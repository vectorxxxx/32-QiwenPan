...
public class DefaultDocumentManager implements DocumentManager
{
    ...
    public String getFileUri(String fileName, Boolean forDocumentServer) {
        try {
            ...
            String filePathDownload = !fileName.contains(InetAddress
                    .getLocalHost()
                    .getHostAddress()) ?
                                      fileName :
                                      fileName.substring(fileName.indexOf(InetAddress
                                              .getLocalHost()
            ...
            String filePath = serverPath + "/download?fileName=" + URLEncoder.encode(filePathDownload,
                    java.nio.charset.StandardCharsets.UTF_8.toString()) + "&userAddress" + URLEncoder.encode(hostAddress, java.nio.charset.StandardCharsets.UTF_8.toString());
            return filePath;
        }
            ...
            String filePathDownload = !fileName.contains(InetAddress
                    ...
                    .getHostAddress()) ?
                                      ...
                                      fileName.substring(fileName.indexOf(InetAddress
                                              ...
                                              .getHostAddress()
                                              .length() + 1);
            String userAddress = forDocumentServer ?
                                 "&userAddress" + URLEncoder.encode(hostAddress, java.nio.charset.StandardCharsets.UTF_8.toString()) :
                                 "";
            String filePath = serverPath + "/downloadhistory?fileName=" + URLEncoder.encode(filePathDownload,
                    java.nio.charset.StandardCharsets.UTF_8.toString()) + "&ver=" + version + "&file=" + file + userAddress;
            return filePath;
        }
        catch (UnsupportedEncodingException | UnknownHostException e) {
            return "";
    ...
    public ArrayList<Map<String, Object>> getFilesInfo() {
        ...
        for (File file : storageMutator.getStoredFiles()) {
            ...
            map.put("id", serviceConverter.generateRevisionId(storagePathBuilder.getStorageLocation() + "/" + file.getName() + "/" + Paths
                    .get(storagePathBuilder.getFileLocation(file.getName()))
                    .toFile()
                    .lastModified()));
