...
{  // the parameters which allow to customize the editor interface so that it looked like your other products (if there are any) and change the presence or absence of the
    // additional buttons, links, change logos and editor owner details
    @Autowired
    ...
    private Boolean compactHeader = false;  // if the additional action buttons are displayed in the upper part of the editor window header next to the logo (false) or in the
    // toolbar (true)
